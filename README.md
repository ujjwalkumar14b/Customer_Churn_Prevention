...
* Average Charges: ``` AvgCharges = TotalCharges / (tenure + 1) ```
* Log transformation: ``` TotalCharges_log = log(1 + TotalCharges) ```
...
## Model Selection
The final model is selected based on **ROC-AUC score**: The model with the higher ROC-AUC is chosen automatically
